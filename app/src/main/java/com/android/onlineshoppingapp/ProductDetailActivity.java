...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private void setEvent() {
        ...
        cardLikePD.setOnClickListener(view -> {
        ...
        // click on cart
        cardViewShoppingCartPD.setOnClickListener(view -> startActivity(new Intent(ProductDetailActivity.this,
                ShoppingCartActivity.class)));

        // click on add to cart
        btnAddToCartPD.setOnClickListener(view -> db.collection("Carts").document(fAuth.getCurrentUser().getUid())
                .collection("Products")
                .document(product.getProductId())
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            Toast.makeText(ProductDetailActivity.this,
                                    "The product has been added to the cart before", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            db.collection("Carts")
                                    ...
                                    .document(product.getProductId())
                                    .set(cartProduct)
                                    .addOnSuccessListener(unused -> Toast.makeText(ProductDetailActivity.this,
    ...
    private void setData(Product product) {
        ...
        tvProductSold.setText("Sold " + product.getQuantitySold());
        tvProductPrice.setText(String.format("%,d", product.getProductPrice()) + "₹");
