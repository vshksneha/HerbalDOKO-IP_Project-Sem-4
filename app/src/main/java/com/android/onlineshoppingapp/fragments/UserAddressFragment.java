    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db.collection("Users").document(Objects.requireNonNull(fAuth.getCurrentUser()).getUid())
                ...
                .addSnapshotListener((value, error) -> {
                    userAddresses.clear();
                    if (error != null) Log.e("getAddress", Objects.requireNonNull(error.getMessage()));
...
//                    });
                    ...
                    if (userAddresses.isEmpty()) {
                        // set Address 1
                        tvFullNameAddress1.setText("Not set yet");
                        tvPhoneNumberAddress1.setText("Not set yet");
                        tvAddress1.setText("Not set yet");

                        // set Address 2
                        tvFullNameAddress2.setText("Not set yet");
                        tvPhoneNumberAddress2.setText("Not set yet");
                        tvAddress2.setText("Not set yet");
        ...
        ivChangeUserAddress.setOnClickListener(view1 -> startActivity(new Intent(getActivity(), ChangeAddressActivity.class)));
